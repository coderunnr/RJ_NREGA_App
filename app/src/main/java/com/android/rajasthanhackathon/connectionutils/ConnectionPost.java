 ...
 */
public class ConnectionPost extends AsyncTask<Void, Void, String> {
...
//    static java.net.CookieManager msCookieManager = new java.net.CookieManager();
    ...
    public ConnectionPost(String url, JSONObject param, Context context) {
        this.url = url;
        this.param = param;
...
//                JSONObject ob =new JSONObject(sb.toString());
                ...
                if(HttpResult==500||HttpResult==404||HttpResult==300)
                {
                    return "failed";
                }
            }
